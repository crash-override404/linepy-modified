...
class addBuddyMembers_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1291 in range(_size1287):
                        _elem1292 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.userMids.append(_elem1292)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.userMids is not None:
            ...
            for iter1293 in self.userMids:
                oprot.writeString(iter1293.encode('utf-8') if sys.version_info[0] == 2 else iter1293)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class commitSendMessagesToAll_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1298 in range(_size1294):
                        _elem1299 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.requestIdList.append(_elem1299)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.requestIdList is not None:
            ...
            for iter1300 in self.requestIdList:
                oprot.writeString(iter1300.encode('utf-8') if sys.version_info[0] == 2 else iter1300)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class commitSendMessagesToAll_result(object):
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1305 in range(_size1301):
                        _elem1306 = SendBuddyMessageResult()
                        _elem1306.read(iprot)
                        self.success.append(_elem1306)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1307 in self.success:
                iter1307.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class commitSendMessagesToMids_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1312 in range(_size1308):
                        _elem1313 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.requestIdList.append(_elem1313)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i1318 in range(_size1314):
                        _elem1319 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1319)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.requestIdList is not None:
            oprot.writeFieldBegin('requestIdList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.requestIdList))
            for iter1320 in self.requestIdList:
                oprot.writeString(iter1320.encode('utf-8') if sys.version_info[0] == 2 else iter1320)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.mids is not None:
            oprot.writeFieldBegin('mids', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.mids))
            for iter1321 in self.mids:
                oprot.writeString(iter1321.encode('utf-8') if sys.version_info[0] == 2 else iter1321)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1326 in range(_size1322):
                        _elem1327 = SendBuddyMessageResult()
                        _elem1327.read(iprot)
                        self.success.append(_elem1327)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class getActiveMemberMidsByBuddyMid_result(object):
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1333 in range(_size1329):
                        _elem1334 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success.append(_elem1334)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1335 in self.success:
                oprot.writeString(iter1335.encode('utf-8') if sys.version_info[0] == 2 else iter1335)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getAllBuddyMembers_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype1339, _size1336) = iprot.readListBegin()
                    for _i1340 in range(_size1336):
                        _elem1341 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success.append(_elem1341)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRING, len(self.success))
            for iter1342 in self.success:
                oprot.writeString(iter1342.encode('utf-8') if sys.version_info[0] == 2 else iter1342)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getBlockedBuddyMembers_result(object):
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1347 in range(_size1343):
                        _elem1348 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success.append(_elem1348)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRING, len(self.success))
            for iter1349 in self.success:
                oprot.writeString(iter1349.encode('utf-8') if sys.version_info[0] == 2 else iter1349)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class linkAndSendBuddyContentMessageToMids_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1354 in range(_size1350):
                        _elem1355 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1355)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.mids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.mids))
            for iter1356 in self.mids:
                oprot.writeString(iter1356.encode('utf-8') if sys.version_info[0] == 2 else iter1356)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class registerBuddy_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 2:
                ...
                if ftype == TType.MAP:
                    self.settings = {}
                    (_ktype1358, _vtype1359, _size1357) = iprot.readMapBegin()
                    for _i1361 in range(_size1357):
                        _key1362 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1363 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.settings[_key1362] = _val1363
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            for kiter1364, viter1365 in self.settings.items():
                oprot.writeString(kiter1364.encode('utf-8') if sys.version_info[0] == 2 else kiter1364)
                oprot.writeString(viter1365.encode('utf-8') if sys.version_info[0] == 2 else viter1365)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class removeBuddyMembers_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1370 in range(_size1366):
                        _elem1371 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.userMids.append(_elem1371)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.userMids is not None:
            oprot.writeFieldBegin('userMids', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.userMids))
            for iter1372 in self.userMids:
                oprot.writeString(iter1372.encode('utf-8') if sys.version_info[0] == 2 else iter1372)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class sendBuddyContentMessageToMids_args(object):
    ...
    def write(self, oprot):
        ...
        if self.mids is not None:
            oprot.writeFieldBegin('mids', TType.LIST, 4)
            oprot.writeListBegin(TType.STRING, len(self.mids))
            for iter1379 in self.mids:
                oprot.writeString(iter1379.encode('utf-8') if sys.version_info[0] == 2 else iter1379)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    self.mids = []
                    (_etype1383, _size1380) = iprot.readListBegin()
                    for _i1384 in range(_size1380):
                        _elem1385 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1385)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class sendBuddyMessageToMids_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    self.mids = []
                    (_etype1390, _size1387) = iprot.readListBegin()
                    for _i1391 in range(_size1387):
                        _elem1392 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1392)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.mids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.mids))
            for iter1393 in self.mids:
                oprot.writeString(iter1393.encode('utf-8') if sys.version_info[0] == 2 else iter1393)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class sendBuddyMessageToMidsAsync_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i1398 in range(_size1394):
                        _elem1399 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.mids.append(_elem1399)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.mids is not None:
            oprot.writeFieldBegin('mids', TType.LIST, 3)
            oprot.writeListBegin(TType.STRING, len(self.mids))
            for iter1400 in self.mids:
                oprot.writeString(iter1400.encode('utf-8') if sys.version_info[0] == 2 else iter1400)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyAdminProfileAttribute_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    self.attributes = {}
                    (_ktype1402, _vtype1403, _size1401) = iprot.readMapBegin()
                    for _i1405 in range(_size1401):
                        _key1406 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1407 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key1406] = _val1407
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            ...
            for kiter1408, viter1409 in self.attributes.items():
                oprot.writeString(kiter1408.encode('utf-8') if sys.version_info[0] == 2 else kiter1408)
                oprot.writeString(viter1409.encode('utf-8') if sys.version_info[0] == 2 else viter1409)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyProfileAttributes_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    self.attributes = {}
                    (_ktype1411, _vtype1412, _size1410) = iprot.readMapBegin()
                    for _i1414 in range(_size1410):
                        _key1415 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1416 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key1415] = _val1416
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter1417, viter1418 in self.attributes.items():
                oprot.writeString(kiter1417.encode('utf-8') if sys.version_info[0] == 2 else kiter1417)
                oprot.writeString(viter1418.encode('utf-8') if sys.version_info[0] == 2 else viter1418)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddyProfileAttributesAsync_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    self.attributes = {}
                    (_ktype1420, _vtype1421, _size1419) = iprot.readMapBegin()
                    for _i1423 in range(_size1419):
                        _key1424 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1425 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.attributes[_key1424] = _val1425
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.attributes is not None:
            oprot.writeFieldBegin('attributes', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.attributes))
            for kiter1426, viter1427 in self.attributes.items():
                oprot.writeString(kiter1426.encode('utf-8') if sys.version_info[0] == 2 else kiter1426)
                oprot.writeString(viter1427.encode('utf-8') if sys.version_info[0] == 2 else viter1427)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class updateBuddySettings_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 2:
                if ftype == TType.MAP:
                    self.settings = {}
                    (_ktype1429, _vtype1430, _size1428) = iprot.readMapBegin()
                    for _i1432 in range(_size1428):
                        _key1433 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        _val1434 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.settings[_key1433] = _val1434
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.settings is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.settings))
            for kiter1435, viter1436 in self.settings.items():
                oprot.writeString(kiter1435.encode('utf-8') if sys.version_info[0] == 2 else kiter1435)
                oprot.writeString(viter1436.encode('utf-8') if sys.version_info[0] == 2 else viter1436)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
