...
class getChannelNotificationSettings_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype1584, _size1581) = iprot.readListBegin()
                    for _i1585 in range(_size1581):
                        _elem1586 = ChannelNotificationSetting()
                        _elem1586.read(iprot)
                        self.success.append(_elem1586)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1587 in self.success:
                iter1587.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getFriendChannelMatrices_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    self.channelIds = []
                    (_etype1591, _size1588) = iprot.readListBegin()
                    for _i1592 in range(_size1588):
                        _elem1593 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.channelIds.append(_elem1593)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1594 in self.channelIds:
                oprot.writeString(iter1594.encode('utf-8') if sys.version_info[0] == 2 else iter1594)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class issueRequestTokenWithAuthScheme_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    self.authScheme = []
                    (_etype1598, _size1595) = iprot.readListBegin()
                    for _i1599 in range(_size1595):
                        _elem1600 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.authScheme.append(_elem1600)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.authScheme is not None:
            ...
            for iter1601 in self.authScheme:
                oprot.writeString(iter1601.encode('utf-8') if sys.version_info[0] == 2 else iter1601)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class getUpdatedChannelIds_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1606 in range(_size1602):
                        _elem1607 = ChannelIdWithLastUpdated()
                        _elem1607.read(iprot)
                        self.channelIds.append(_elem1607)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.channelIds is not None:
            ...
            for iter1608 in self.channelIds:
                iter1608.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getUpdatedChannelIds_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype1612, _size1609) = iprot.readListBegin()
                    for _i1613 in range(_size1609):
                        _elem1614 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success.append(_elem1614)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1615 in self.success:
                oprot.writeString(iter1615.encode('utf-8') if sys.version_info[0] == 2 else iter1615)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class updateChannelNotificationSetting_args(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    self.setting = []
                    (_etype1619, _size1616) = iprot.readListBegin()
                    for _i1620 in range(_size1616):
                        _elem1621 = ChannelNotificationSetting()
                        _elem1621.read(iprot)
                        self.setting.append(_elem1621)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.setting is not None:
            ...
            for iter1622 in self.setting:
                iter1622.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
