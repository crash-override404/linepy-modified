...
class notifyEmailConfirmationResult_args(object):
    ...
    def write(self, oprot):
        ...
        if self.parameterMap is not None:
            ...
            for kiter1285, viter1286 in self.parameterMap.items():
                oprot.writeString(kiter1285.encode('utf-8') if sys.version_info[0] == 2 else kiter1285)
                oprot.writeString(viter1286.encode('utf-8') if sys.version_info[0] == 2 else viter1286)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
