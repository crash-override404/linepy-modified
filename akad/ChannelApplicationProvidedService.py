    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype1484, _size1481) = iprot.readListBegin()
                    for _i1485 in range(_size1481):
                        _elem1486 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1487 in self.success:
                oprot.writeString(iter1487.encode('utf-8') if sys.version_info[0] == 2 else iter1487)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    self.success = []
                    (_etype1491, _size1488) = iprot.readListBegin()
                    for _i1492 in range(_size1488):
                        _elem1493 = CompactContact()
...
class getContactsForChannel_args(object):
            ...
            if fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i1499 in range(_size1495):
                        _elem1500 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem1500)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ids is not None:
            ...
            for iter1501 in self.ids:
                oprot.writeString(iter1501.encode('utf-8') if sys.version_info[0] == 2 else iter1501)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1513 in range(_size1509):
                        _elem1514 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1515 in self.success:
                oprot.writeString(iter1515.encode('utf-8') if sys.version_info[0] == 2 else iter1515)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1520 in range(_size1516):
                        _elem1521 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1522 in self.success:
                oprot.writeString(iter1522.encode('utf-8') if sys.version_info[0] == 2 else iter1522)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1527 in range(_size1523):
                        _elem1528 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter1529 in self.success:
                oprot.writeString(iter1529.encode('utf-8') if sys.version_info[0] == 2 else iter1529)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getGroupsForChannel_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1534 in range(_size1530):
                        _elem1535 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.groupIds.append(_elem1535)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.groupIds is not None:
            ...
            for iter1536 in self.groupIds:
                oprot.writeString(iter1536.encode('utf-8') if sys.version_info[0] == 2 else iter1536)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class getSimpleChannelContacts_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i1555 in range(_size1551):
                        _elem1556 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.ids.append(_elem1556)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.ids))
            for iter1557 in self.ids:
                oprot.writeString(iter1557.encode('utf-8') if sys.version_info[0] == 2 else iter1557)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1562 in range(_size1558):
                        _elem1563 = SimpleChannelContact()
...
class getUserIdentities_result(object):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    self.success = {}
                    (_ktype1566, _vtype1567, _size1565) = iprot.readMapBegin()
                    for _i1569 in range(_size1565):
                        _key1570 = iprot.readI32()
                        _val1571 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success[_key1570] = _val1571
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter1572, viter1573 in self.success.items():
                oprot.writeI32(kiter1572)
                oprot.writeString(viter1573.encode('utf-8') if sys.version_info[0] == 2 else viter1573)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
...
class getUserMidsWhoAddedMe_result(object):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i1578 in range(_size1574):
                        _elem1579 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                        self.success.append(_elem1579)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRING, len(self.success))
            for iter1580 in self.success:
                oprot.writeString(iter1580.encode('utf-8') if sys.version_info[0] == 2 else iter1580)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.e is not None:
            oprot.writeFieldBegin('e', TType.STRUCT, 1)
